...
if ( ! function_exists( 'understrap_all_excerpts_get_more_link' ) ) {
	...
	<span class="share-text">' . __( 'Share:', 'understrap' ) . '</span>
		...
		<i class="my-auto ml-0 fa fa-share-alt"></i>
			...
			return $post_excerpt . '<div class="row no-gutters excerpt"><a class="btn my-auto button btn-secondary understrap-read-more-link text-uppercase" href="' . esc_url( get_permalink( get_the_ID() ) ) . '">' . __( 'Full Quotes',
					'understrap' ) . '</a>
	<div class="ml-auto no-gutters text-uppercase post-share-text row align-items-center">
	 <time class="post-time text-uppercase"
                                      datetime="' . the_date( 'Y-m-d' ) . '">' . get_the_time( 'd-M-Y' ) . '</time>
	<span class="share-text">' . __( 'Share:', 'understrap' ) . '</span>
		...
		<i class="my-auto ml-0 fa fa-share-alt"></i>
			...
			return $post_excerpt . '<div class="row no-gutters excerpt"><a class="btn my-auto button btn-secondary understrap-read-more-link text-uppercase" href="' . esc_url( get_permalink( get_the_ID() ) ) . '">' . __( 'Read More',
					'understrap' ) . '</a>
	<div class="ml-auto no-gutters text-uppercase post-share-text row align-items-center"><span class="share-text">' . __( 'Share:', 'understrap' ) . '</span>
		<ul class="list-inline my-auto ml-auto share-list">
			<li class="list-inline-item"><a class="share" href="#"><i class="fa fa-facebook-f"></i></a></li>
			<li class="list-inline-item"><a class="share" href="#"><i class="fa fa-twitter"></i></a></li>
			<li class="list-inline-item"><a class="share" href="#"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
