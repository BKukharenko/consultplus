...
{
    $args ['class_form'] = 'd-flex flex-column mt-5';
    $args['title_reply'] = '<span class="d-block text-uppercase leave-text">'.__( 'Leave', 'understrap' ) .'</span>
<h2 class="article-section-header d-inline-block text-uppercase">' . __('Message', 'understrap') . '</h2>';
    ...
    $args['class_submit'] = 'btn button'; // since WP 4.1.
    return $args;
}
